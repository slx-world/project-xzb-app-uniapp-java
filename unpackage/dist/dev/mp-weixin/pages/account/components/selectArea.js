...
const _sfc_main = {
  ...
  setup(__props, { expose, emit: emits }) {
    ...
    common_vendor.watch(props, (newValue, oldValue) => {
      ...
      areaIndex.data[2] = (_c = utils_address_area.areaData[areaIndex.data[0]][areaIndex.data[1]]) == null ? void 0 : _c.findIndex(
        (item) => {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-00e56261"], ["__file", "E:/project/小智帮/project-xzb-app-uniapp-java（服务端）/pages/account/components/selectArea.vue"]]);
