...
const _sfc_main = {
  ...
  setup(__props, { expose, emit }) {
    ...
    const getOrderInfoFunc = (id) => {
      type.value === "dispatch" ? pages_api_order.getDispatchOrderInfo(id).then((res) => {
        info.data = res.data;
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-c0232ef0"], ["__file", "E:/project/小智帮/project-xzb-app-uniapp-java（服务端）/pages/orderInfo/index.vue"]]);
