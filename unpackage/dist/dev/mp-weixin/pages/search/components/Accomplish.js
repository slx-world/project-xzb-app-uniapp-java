  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        a: __props.item.taskType === 2 && __props.item.status === 2
      }, __props.item.taskType === 2 && __props.item.status === 2 ? common_vendor.e({
...
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "E:/project/\u5C0F\u667A\u5E2E/project-xzb-app-uniapp-java\uFF08\u670D\u52A1\u7AEF\uFF09/pages/search/components/Accomplish.vue"]]);
