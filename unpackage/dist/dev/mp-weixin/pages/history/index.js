...
if (!Math) {
  (UniNav + common_vendor.unref(HomeList) + Empty + UniFooter)();
}
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        b: common_vendor.o(_ctx.handleEdit),
        c: common_vendor.p({
          title: "历史订单",
          rithtText: "筛选"
        }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-b37acf1c"], ["__file", "E:/project/小智帮/project-xzb-app-uniapp-java（服务端）/pages/history/index.vue"]]);
