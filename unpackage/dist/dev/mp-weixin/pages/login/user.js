  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        p: common_vendor.sr(alertDialog, "55b32450-5", {
          "k": "alertDialog"
        }),
        q: common_vendor.p({
          type: "dialog",
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "E:/project/小智帮/project-xzb-app-uniapp-java（服务端）/pages/login/user.vue"]]);
